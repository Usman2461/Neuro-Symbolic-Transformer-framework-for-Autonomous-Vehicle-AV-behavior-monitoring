...
from evaluation.plotting import plot_metrics, plot_shap, plot_rule_timeline
...
def train():
    ...
    plot_metrics(history, save_path="results/metrics_curve.png")
    ...
    plot_shap(importance, save_path="results/shap_importance.png")
    rule_acts = engine.evaluate(preds, predicate_names).detach().cpu().numpy()
    plot_rule_timeline(rule_acts, save_path="results/rule_timeline.png")
